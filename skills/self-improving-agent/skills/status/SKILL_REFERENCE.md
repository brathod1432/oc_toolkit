...
# AI_RUNTIME_GUIDE.md
wc -l ./AI_RUNTIME_GUIDE.md 2>/dev/null || echo "0"
wc -l ~/.claude/AI_RUNTIME_GUIDE.md 2>/dev/null || echo "0"
...
| AI_RUNTIME_GUIDE.md lines | < 150 | 150-200 | > 200 |
...
ðŸ“Š Memory Status
  ...
  Project Rules:
    AI_RUNTIME_GUIDE.md:    {{n}} lines
    Rules:        {{count}} files in .claude/rules/
    User global:  {{n}} lines (~/.claude/AI_RUNTIME_GUIDE.md)
...
- Topic files are fine â€” AI assistant creates them to keep MEMORY.md under 200 lines
