...
Generates reports adapted for AI assistant Desktop (rich markdown) or CLI (terminal-friendly),
...
class ReportGenerator:
    ...
    def _detect_context(self) -> str:
        ...
        """
        # Check for AI assistant Desktop environment variables or indicators
        # This is a simplified detection - actual implementation would check for
        # AI assistant Desktop-specific environment variables
